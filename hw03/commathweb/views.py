...
def aaa32(req):
	if req.method == 'POST':
		...
		return render(req,'aaa32.html',{'s':s,'e':e,'f':f,'conb':conb,'d':d})
	else :
		return render(req,'aaa32.html')
...
def aaa64(req):
	if req.method == 'POST':
		...
		return render(req,'aaa64.html',{'s':s,'e':e,'f':f,'d':d,'conb':conb})
	else:
		return render(req,'aaa64.html')
	#pass
